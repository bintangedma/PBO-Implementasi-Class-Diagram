...
class Marketing_crewView(QDialog):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Marketing Team FORM.")
        self.setModal(True)
        self.resize(550, 350)
        ...
        lbljudul = QLabelRC("Data Marketing Crew", "rgb(125, 15, 15)")
        ...
        self.cmbauthority.addItems(
            ['Marketing Crew'])
        self.pilAuthority = [Emptype.Marketing_crew]
